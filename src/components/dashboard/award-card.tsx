...
const AwardsCard: React.FC<AwardsCardProps> = ({ 
  ...
  const renderIcon = (iconType: string) => {
    switch(iconType) {
      ...
      case 'users':
        return <div className="bg-green-100 p-3 rounded-full"><Users className="h-6 w-6 text-green-600" /></div>;
      case 'star':
        return <div className="bg-yellow-100 p-3 rounded-full"><Star className="h-6 w-6 text-yellow-600" /></div>;
      case 'book':
        return <div className="bg-indigo-100 p-3 rounded-full"><BookOpen className="h-6 w-6 text-indigo-600" /></div>;
      case 'target':
        return <div className="bg-red-100 p-3 rounded-full"><Target className="h-6 w-6 text-red-600" /></div>;
      default:
        return <div className="bg-gray-100 p-3 rounded-full"><Award className="h-6 w-6 text-gray-600" /></div>;
    }
  };
    ...
    <Card className={`mb-4 ${className}`}>
      <CardHeader className="pb-2">
        <div className="flex justify-between items-center">
          ...
          <Button variant="link" className="text-sm p-0" onClick={onViewAll}>View All</Button>
        </div>
      </CardHeader>
      <CardContent>
