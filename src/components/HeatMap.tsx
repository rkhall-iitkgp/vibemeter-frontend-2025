...
// Define the HeatMapProps to accept workHours
interface HeatMapProps {
  workHours: { date: string; hours: number }[]; // Expecting an array of objects with date and hours
}

const HeatMap: React.FC<HeatMapProps> = ({ workHours }) => {
  ...
  // Process the workHours data to match the expected format
  const processedData = workHours.map((day) => ({
