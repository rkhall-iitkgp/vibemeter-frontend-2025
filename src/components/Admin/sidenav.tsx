...
const defaultMenuSections: MenuSection[] = [
	{
		title: "Main",
		items: [
			{ name: "Overview", img_src: menuIcons["Overview"], link: "admin", notifications: 1 },
			{ name: "Employees", img_src: menuIcons["Employees"], link: "employees" },
			{ name: "Focus Groups", img_src: menuIcons["Focus Groups"], link: "focus-groups" },
		],
	},
	{
		title: "Engagement",
	...
	},
	{
		title: "Improvement",
		items: [
			{ name: "Action Plans", img_src: menuIcons["Action Plans"], link: "action-plan" },
			{ name: "Initiatives", img_src: menuIcons["Initiatives"], link: "initiatives" },
		],
	},
	{
		title: "Support",
							...
							{section.items.map((item, itemIndex) => {
								...
								return (
									<li
										...
										className={`relative flex items-center p-3 rounded-lg cursor-pointer ${isActive
