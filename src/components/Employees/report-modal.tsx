...
export function ReportModal({
  ...
  const getVibeTrendColor = (trend: string) => {
    ...
    if (trendLower.includes("positive") || trendLower.includes("upward")) {
      ...
      trendLower.includes("negative") ||
      trendLower.includes("downward")
    ) {
      return "text-red-600";
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                      <div className="bg-gray-50 p-3 rounded-md">
                        ...
                        <p className="text-2xl font-bold">
                          {
                            report.content.conversation_summary.issues_discussed
                              .length
                          }
                        </p>
                        <div className="text-xs text-gray-500 mt-1">
                          ...
                          {report.content.conversation_summary.issues_discussed
                            ...
                            <span>
                              +{" "}
                              {report.content.conversation_summary
                                .issues_discussed.length - 2}{" "}
                              more
                            </span>
                          )}
                        </div>
                      ...
                      <div className="bg-gray-50 p-3 rounded-md">
                        ...
                        <p className="text-2xl font-bold">
                          {report.content.conversation_summary.themes.length}
                        </p>
                        <div className="flex flex-wrap gap-1 mt-1">
                          {report.content.conversation_summary.themes.length >
                          0 ? (
                            report.content.conversation_summary.themes
                              .slice(0, 2)
                              .map((theme, i) => (
                                <span
                                  key={i}
                                  className="px-1.5 py-0.5 bg-gray-200 rounded-full text-xs truncate max-w-full"
                                >
                                  {theme}
                                </span>
                              ))
                      ...
                      <div className="bg-gray-50 p-3 rounded-md">
                        ...
                        <p
                          className={`text-lg font-bold ${getVibeTrendColor(report.content.metrics.vibe_trend)}`}
                        >
                          {capitalize(
                            report.content.metrics.vibe_trend || "No data"
                          )}
                        </p>
                        {report.content.metrics.avg_work_hours && (
                          <p className="text-xs text-gray-500 mt-1">
                            Avg hours: {report.content.metrics.avg_work_hours}{" "}
                            hrs/day
                          </p>
                        )}
                      </div>
                ...
                <div className="p-4">
                  <div className="grid md:grid-cols-2 gap-4">
                    ...
                    <div>
                      ...
                      {selectedReport.content.conversation_summary
                        .issues_discussed.length > 0 ? (
                        <ul className="space-y-1 pl-4">
                          {selectedReport.content.conversation_summary.issues_discussed.map(
                            (issue, i) => (
                              <li
                                key={i}
                                className="text-sm capitalize list-disc"
                              >
                                {issue}
                              </li>
                            )
                        ...
                        <p className="text-sm text-gray-500 italic">
                          No issues discussed were recorded.
                        </p>
                      )}
                    </div>
                    ...
                    <div>
                      ...
                      selectedReport.content.conversation_summary.themes
                        ...
                        <div className="flex flex-wrap gap-2">
                          {selectedReport.content.conversation_summary.themes.map(
                            (theme, i) => (
                              <span
                                key={i}
                                className="px-2.5 py-1 bg-gray-100 rounded-md text-xs"
                              >
                                {theme}
                              </span>
                            )
                  ...
                  Object.keys(
                    ...
                    <div className="space-y-4">
                      {Object.entries(
                        ...
                        <div
                          key={category}
                          className={causes.length > 0 ? "mb-3" : "hidden"}
                        >
                    ...
                    <p className="text-sm text-gray-500 italic">
                      No root causes were identified.
                    </p>
                  )}
                </div>
              </div>
                ...
                <div className="p-4">
                  <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                    <div className="bg-gray-50 p-4 rounded-md">
                      ...
                      <p
                        className={`font-medium text-lg ${getVibeTrendColor(selectedReport.content.metrics.vibe_trend)}`}
                      >
                        {capitalize(
                          selectedReport.content.metrics.vibe_trend || "No data"
                        )}
                      </p>
                    </div>
                    {selectedReport.content.metrics.performance_rating !==
                      null &&
                      selectedReport.content.metrics.performance_rating !==
                        undefined && (
                        <div className="bg-gray-50 p-4 rounded-md">
                    ...
                    {selectedReport.content.metrics.avg_work_hours !== null &&
                      selectedReport.content.metrics.avg_work_hours !==
                        undefined && (
                        <div className="bg-gray-50 p-4 rounded-md">
                          <h4 className="text-sm text-gray-500 mb-1">
                            Avg Work Hours
                  ...
                  <div className="bg-white rounded-lg border overflow-hidden">
                    ...
                    <div className="p-4">
                      <ul className="space-y-2 pl-4">
                        {selectedReport.content.recommendations.map(
                          (rec, i) => (
                            <li key={i} className="text-sm list-disc">
