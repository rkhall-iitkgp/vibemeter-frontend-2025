...
const MeetingScheduler: React.FC<MeetingSchedulerProps> = ({
  ...
  return (
    <div className="max-w-lg w-lg mx-auto bg-white rounded-lg shadow-md p-6 relative">
      <button
        onClick={onClose}
      ...
      <form onSubmit={handleSubmit}>
        ...
        <div className="flex gap-4 mt-6">
          ...
          <button
            type="submit"
            disabled={loading}
            className="disabled:bg-[#a8dd76] flex-1 bg-[#80C342] hover:bg-[#80c342ed] text-white font-bold py-3 px-4 rounded flex items-center justify-center gap-1"
          >
