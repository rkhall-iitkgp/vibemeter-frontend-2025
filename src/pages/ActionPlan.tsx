...
import { ActionPlanContent } from "@/components/ActionPlan/ActionPlanContent";
...
const mapResponseToActionPlan = (item) => {
  return {
    ...
    targetGroup: item.target_groups && item.target_groups.length > 0 ? item.target_groups[0].name : "All Groups",
    groupId: item.target_groups && item.target_groups.length > 0 ? `#${item.target_groups[0].focus_group_id}` : "#N/A",
    tags: item.metric || [],
  }
}
  ...
  return (
    <div className="flex-1 overflow-auto">
      ...
      <main className="p-6 pt-2">
        {/* Carousel Section */}
        <div className="mb-10">
          <ActionPlansCarouselContent isLoading={isLoading}>
            <ActionPlansCarousel />
        ...
        <div className="mb-8">
          ...
          <div className="flex justify-between items-center mb-6">
            <div className="flex gap-2 items-center">
              ...
              <SortBy sortBy={sortBy} setSortBy={setSortBy} sortOpen={sortOpen} setSortOpen={setSortOpen} />
            </div>
          ...
          {deleteError && <div className="bg-red-50 p-4 rounded-md text-red-700 mb-4">{deleteError}</div>}
        ...
        {/* Initiative Modal */}
        {isInitiativeModalOpen && <InitiativeModal onClose={closeInitiativeModal} onSuccess={fetchActionPlans} />}
