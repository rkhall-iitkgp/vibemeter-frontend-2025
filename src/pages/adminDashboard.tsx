...
import EmployeeSatisfactionGauge, { EmployeeSatisfaction } from "@/components/Admin/employee-satisfaction";
import HighConcernEmployees, { Employee } from "@/components/Admin/new-high-concern-employee";
import VibemeterChart, { ChartData } from "@/components/Admin/average-vibemeter-score";
			...
			<main className="p-6">
				...
				>
					...
					<div className="bg-white rounded-lg shadow overflow-hidden h-full">
						<HighConcernEmployees employees={data.high_concern_employees} loading={loading}/>
					</div>
				</div>
				...
				<div className="mt-4" ref={section2Ref}>
					<div className="bg-white rounded-lg shadow overflow-hidden">
						<AdminBubbleChart data={data.bubble_data} />
					</div>
				</div>
			</main>
		</div>
