  ...
  const generateMultiPagePDF = async () => {
    ...
    try {
      ...
      for (let i = 0; i < sections.length; i++) {
        ...
        pdf.text(`Dashboard Report - Page ${i + 1}`, 105, 15, { align: "center" });
        ...
        try {
          ...
          pdf.text(`Page ${pageNumber} of ${sections.length + 1}`, 105, 287, { align: "center" });
        } catch (error) {
  ...
  return (
    <div className="flex-1 overflow-auto">
      ...
      <main className="p-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4" ref={section1Ref}>
