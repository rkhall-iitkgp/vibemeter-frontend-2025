...
import { AppDispatch, fetchHighRiskEmployees, RootState } from "@/store";
...
export default function AdminDashboard() {
	...
	const highRiskEmployeeState = useSelector((state: RootState) => state.highRiskEmployees)
				...
				>
					...
					<div className="bg-white rounded-lg shadow overflow-hidden h-full">
						<HighConcernEmployees
							employees={highRiskEmployeeState.highRiskEmployees}
							loading={highRiskEmployeeState.loading}
						/>
					</div>
				</div>
