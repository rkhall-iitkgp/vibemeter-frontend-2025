...
import { RootState, setEscalation } from "../index";
		...
		switch (actionObj.type) {
			...
			case "ws/connect": {
				...
				socket = new WebSocket(
					`${import.meta.env.VITE_WS_URL}/api/chat/${actionObj.payload}`
				);
					...
					try {
						...
						switch (data.event) {
							...
							case "end":
								...
								break;
							case "escalation":
								dispatch(setEscalation({ employee_id: data.message, escalation: true }));
								break;
							default:
